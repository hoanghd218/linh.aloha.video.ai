...
const includedFeatures = [
  ...
  "Bộ CLAUDE.md template cho thương hiệu cá nhân",
  "5 Skills marketing sẵn dùng: market-researcher, idea-generator, content-writer, book-outliner, seo-optimizer",
  "Hướng dẫn setup MCP: Gmail, Notion, GitHub, Chrome DevTools",
  "Hướng dẫn deploy lên Modal + GitHub Actions cho marketer không code",
  "Review capstone project cá nhân với mentor",
  "Cộng đồng học viên Zalo hỗ trợ sau khoá học",
];

export default function PricingMastery() {
  return (
    <section
