        ...
        {hotline ? (
          <div
            style={{
              ...
              gap: 20,
              padding: '20px 48px',
              background: 'linear-gradient(180deg, #ff4757 0%, #e63946 60%, #c81d25 100%)',
              border: `4px solid ${accent}`,
              borderRadius: 999,
              boxShadow:
                '0 16px 36px rgba(230,57,70,0.55), 0 6px 0 rgba(0,0,0,0.35), inset 0 2px 0 rgba(255,255,255,0.35)',
            }}
          >
            <span
              style={{
