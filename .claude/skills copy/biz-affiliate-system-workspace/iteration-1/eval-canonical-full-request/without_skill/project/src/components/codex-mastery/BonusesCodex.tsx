...
const bonuses: Bonus[] = [
  {
    tag: "BONUS #1",
    title: "Bộ 30+ System Prompt Marketing Thực Chiến",
    desc: "System prompt cho content writer, SEO specialist, email marketer, social media manager — plug & play theo brand của bạn.",
    value: "1.500.000đ",
    icon: "list_alt",
  },
  {
    tag: "BONUS #2",
    title: "Marketing Automation Toolkit (5 Pipeline)",
    desc: "Content pipeline, SEO pipeline, email sequence builder, social scheduler, competitor research — đã build sẵn, chỉ cần cấu hình.",
    value: "3.000.000đ",
    icon: "auto_awesome",
  },
  {
    tag: "BONUS #3",
    title: "Productivity Templates Cho 10 Workflow",
    desc: "Daily briefing, weekly report, meeting notes, KPI dashboard, email classifier — dùng được ngay, không cần chỉnh sửa nhiều.",
    value: "1.000.000đ",
    icon: "dashboard",
  },
  {
    ...
    desc: "3 buổi/tháng — review pipeline, debug automation, tư vấn case thực tế của bạn với Tony Hoang.",
    value: "5.000.000đ",
    icon: "forum",
  },
  {
    ...
    desc: "Nơi 200+ AI builder chia sẻ case, trao đổi prompt, review pipeline lẫn nhau. Truy cập trọn đời.",
  ...
  },
  {
    ...
    desc: "Toàn bộ 3 buổi + 3 tháng Q&A. Xem lại không giới hạn, update khi ChatGPT Codex ra tính năng mới.",
    value: "2.000.000đ",
    icon: "video_library",
  },
];

const totalValue = "12.500.000đ+";

export default function BonusesCodex() {
  return (
        ...
        <ScrollReveal>
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-base sm:text-lg text-on-surface-variant mt-3 sm:mt-4">
              Tất cả bonus tặng kèm khi đăng ký khoá học —{" "}
              <span className="text-primary font-bold">không tính thêm phí</span>
            </p>
          </div>
        </ScrollReveal>
          ...
          <div className="mt-8 sm:mt-12 max-w-2xl mx-auto bg-surface-container-high rounded-2xl sm:rounded-3xl p-5 sm:p-8 border-2 border-primary/30 shadow-[0_0_40px_rgba(245,158,11,0.1)]">
            <div className="space-y-2.5 sm:space-y-3 mb-5 sm:mb-6">
              <div className="flex items-center justify-between text-sm sm:text-base text-on-surface-variant pb-2 border-b border-outline-variant/20">
                <span>Khoá học ChatGPT Codex Mastery (3 buổi)</span>
                <span className="font-bold line-through decoration-red-500 decoration-2">7.000.000đ</span>
              </div>
              <div className="flex items-center justify-between text-sm sm:text-base text-on-surface-variant pb-2 border-b border-outline-variant/20">
                <span>6 Bonus đi kèm</span>
                <span className="font-bold line-through decoration-red-500 decoration-2">{totalValue}</span>
              </div>
              ...
              <div className="flex items-center justify-between pt-2 gap-3">
                <span className="text-sm sm:text-base font-bold text-on-surface">Bạn sở hữu qua</span>
            ...
            <div className="text-center py-3 px-4 rounded-xl bg-primary/10 border border-primary/30">
              <span className="text-sm sm:text-base text-primary font-black">
                TOÀN BỘ BONUS TẶNG KÈM — KHÔNG TÍNH THÊM PHÍ
              </span>
            </div>
          </div>
        </ScrollReveal>
