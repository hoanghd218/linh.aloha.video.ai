...
export default function GuaranteeVibeCoding() {
  return (
              ...
              <div className="flex justify-center">
                <div className="relative w-32 h-32 sm:w-44 sm:h-44 flex items-center justify-center">
                  ...
                  <div className="relative z-10 text-center">
                    <div className="text-[9px] sm:text-xs font-black text-primary uppercase tracking-wider">Cam kết</div>
                    <div className="text-2xl sm:text-4xl font-black text-on-surface leading-none mt-0.5">100%</div>
                    <div className="text-[9px] sm:text-xs font-black text-primary uppercase tracking-wider mt-0.5">Hoàn tiền</div>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center md:text-left space-y-4 sm:space-y-5">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-on-surface tracking-tighter">
                  ...
                  <span className="text-transparent bg-clip-text bg-linear-to-r from-primary via-primary-container to-secondary">
                    Bạn Chưa Build Được Gì
                  </span>
                </h2>

                <p className="text-sm sm:text-base text-on-surface-variant leading-relaxed">
                  Chúng tôi tự tin đến mức: nếu sau buổi 2 bạn chưa deploy được 1 sản phẩm thật —{" "}
                  <span className="text-on-surface font-bold">
                    chúng tôi hoàn lại 100% học phí
                  </span>
                  , không cần giải thích. Bạn vẫn giữ toàn bộ recording và bonus đã nhận.
                </p>
                ...
                <div className="space-y-2 pt-2">
                  {[
                    ...
                    <div key={item} className="flex gap-2 items-start text-xs sm:text-sm text-on-surface-variant justify-center md:justify-start">
