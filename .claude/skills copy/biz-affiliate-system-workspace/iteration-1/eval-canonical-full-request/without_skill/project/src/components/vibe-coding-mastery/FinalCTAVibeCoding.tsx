...
export default function FinalCTAVibeCoding() {
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-6 bg-linear-to-t from-secondary-container/30 to-surface relative overflow-hidden">
      ...
      <ScrollReveal>
        <div className="max-w-4xl mx-auto text-center space-y-8 sm:space-y-10 relative z-10">
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-primary/15 border border-primary/30 text-primary font-bold text-[10px] sm:text-xs uppercase tracking-widest animate-bounce-subtle">
            <span className="material-symbols-outlined text-primary animate-pulse text-sm sm:text-base">workspace_premium</span>
            5 BUỔI ZOOM LIVE · 8.000.000Đ · CAM KẾT HOÀN TIỀN
          </div>
          ...
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tighter px-2">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-primary via-primary-container to-secondary animate-gradient">
              Được Build Thành Sản Phẩm Thật.
            </span>
          </h2>

          <p className="text-base sm:text-xl text-on-surface-variant max-w-2xl mx-auto">
            Trong khi đối thủ của bạn vẫn chờ dev hoặc trả tiền 30-100 triệu cho mỗi website,
            bạn đã có thể tự build và deploy trong{" "}
            <span className="text-primary font-bold">1 buổi học.</span>
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 max-w-3xl mx-auto">
            {[
              ...
              },
              {
                ...
                desc: "Templates, prompts, SePay guide — trị giá 16 triệu",
              },
              {
                icon: "shield",
                title: "Cam kết hoàn tiền",
                desc: "100% sau buổi 2 nếu chưa build được sản phẩm nào",
              },
            ].map((r) => (
              <div key={r.title} className="bg-surface-container-high/80 backdrop-blur rounded-xl p-4 border border-primary/20">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-on-surface-variant text-xs sm:text-sm">
              ...
              <span>
                Đã có <span className="font-bold text-on-surface">2,400+</span> thành viên Pro · Slot có hạn
              </span>
            </div>
          </div>
          ...
          <div className="pt-6 sm:pt-8 border-t border-outline-variant/20 max-w-2xl mx-auto">
            <p className="text-xs sm:text-sm text-on-surface-variant italic">
              &ldquo;Vibe Coding Mastery không bán lẻ ở bất kỳ đâu. Đây là đặc quyền chỉ dành cho thành viên
              Freedom Builder Pro — cùng với 6 bonus 16 triệu và cam kết hoàn tiền 100% sau buổi 2. Nếu bạn
              muốn tự build sản phẩm số kinh doanh được ngay, đây là con đường ngắn nhất.&rdquo;
            </p>
