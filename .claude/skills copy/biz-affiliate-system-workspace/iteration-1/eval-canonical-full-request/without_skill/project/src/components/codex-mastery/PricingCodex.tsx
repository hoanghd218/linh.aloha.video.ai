...
const includedFeatures = [
  "3 buổi Zoom live trực tiếp với Tony Hoang (~2.5h/buổi)",
  "Recording trọn bộ khoá học — xem lại không giới hạn",
  "Bộ 30+ system prompt marketing sẵn dùng",
  "5 Marketing & Productivity Pipelines đã build sẵn",
  "Productivity templates cho 10 workflow nội bộ",
  "Hướng dẫn kết nối Gmail, Notion, Google Sheets",
  "Hướng dẫn deploy GitHub Actions cho automation không code",
  "Review capstone project cá nhân với mentor",
  "Cộng đồng học viên Zalo hỗ trợ sau khoá học",
];

export default function PricingCodex() {
  return (
    <section
          ...
          <div className="relative bg-surface-container-high rounded-3xl sm:rounded-4xl p-6 sm:p-10 md:p-12 border-2 border-primary/30 shadow-[0_0_60px_rgba(245,158,11,0.15)]">
            <div className="text-center space-y-6 sm:space-y-8">
              ...
              <p className="text-xs sm:text-sm text-on-surface-variant">
                Liên hệ Zalo để đăng ký · Lớp giới hạn 50 học viên
              </p>
            </div>
          </div>
        </ScrollReveal>
