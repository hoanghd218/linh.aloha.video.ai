...
const testimonials: Testimonial[] = [
  {
    quote:
      "Mình là dân marketing thuần, không biết code. Sau buổi 1 đã có content pipeline chạy được và tự gen 20 bài outline trong 15 phút. Tiết kiệm ít nhất 15 triệu/tháng tiền thuê freelancer.",
    name: "Chị Hằng T.",
  ...
  {
    quote:
      "Phần kết nối Gmail + Notion thực sự đã thay đổi cách mình vận hành agency. Giờ 1 người mình làm được việc của 4 nhân viên, team gọn lại, lợi nhuận tăng gấp đôi.",
    name: "Anh Phong L.",
  ...
  {
    quote:
      "Mình đã học 3 khoá AI khác trước đó, đều toàn lý thuyết. Khoá này khác hẳn — build sản phẩm thật từ buổi 1. Automation pipeline của mình giờ đang chạy production, tạo lead tự động mỗi ngày.",
    name: "Anh Tuấn M.",
  ...
  {
    quote:
      "Team marketing 5 người của mình giờ chỉ cần 2 người + 1 Codex pipeline. Hiệu suất content tăng gấp 6 lần. Cost trên mỗi bài viết giảm từ 500K xuống còn 20K.",
    name: "Chị Trang V.",
...
export default function TestimonialsCodex() {
  return (
        ...
        <ScrollReveal>
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-base sm:text-lg text-on-surface-variant mt-3 sm:mt-4">
              Đây là những gì họ đạt được sau khi áp dụng ChatGPT Codex vào marketing & công việc
            </p>
          </div>
        </ScrollReveal>
              ...
              <div className="bg-surface-container-high rounded-2xl p-5 sm:p-6 border border-primary/10 hover:border-primary/30 transition-all duration-300 h-full flex flex-col">
                ...
                <div className="mt-4 pt-4 border-t border-outline-variant/20 flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="font-bold text-sm text-on-surface truncate">{t.name}</div>
                    <div className="text-[10px] sm:text-xs text-on-surface-variant truncate">{t.role}</div>
                  </div>
                </div>
              </div>
            </ScrollReveal>
