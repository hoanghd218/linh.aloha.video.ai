...
def main() -> int:
    ...
    for n, b in enumerate(spec):
        ...
        beats.append({
            ...
            "role": b.get("role"),
            # Profile bds-broker: which image category this beat may use, and
            # whether it may use one at all ("none" = giá/CTA/trừu tượng).
            "assetCategory": b.get("assetCategory"),
            "mediaPolicy": b.get("mediaPolicy", "allow"),
            "anchor_context": ctx,
        })
