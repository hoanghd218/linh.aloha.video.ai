...
-- Tạo schema cho Agent Camp payment lead store + email campaigns + TTL cleanup qua pg_cron.
--
...
-- Chat leads — leads tự động extract từ chatbot widget (dedup theo phone)
