...
const forWho = [
  ...
  "Chủ doanh nghiệp muốn tự động hoá marketing và quy trình nội bộ",
  "Content creator muốn tập trung sáng tạo, AI lo phần sản xuất",
  "Sales & BD muốn tự động hoá email outreach và follow-up",
  "Manager muốn tự động tổng hợp báo cáo, không mất nửa ngày",
  "Người không biết code nhưng muốn làm chủ AI Productivity",
];

const notForWho = [
  "Người tìm \"bí kíp giàu nhanh\" không cần làm gì",
  "Người không sẵn sàng dành 2.5h/buổi học thực hành",
  "Người chỉ muốn lý thuyết, không muốn build hệ thống thực",
  "Người kỳ vọng AI thay thế 100% tư duy sáng tạo của con người",
];

export default function WhoForCodex() {
  return (
