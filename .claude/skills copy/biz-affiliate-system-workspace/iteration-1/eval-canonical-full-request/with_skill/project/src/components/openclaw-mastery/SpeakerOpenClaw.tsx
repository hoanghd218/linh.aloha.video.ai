...
export default function SpeakerOpenClaw() {
  return (
    <section
              ...
              <div className="space-y-4 sm:space-y-5 text-center md:text-left flex-1">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-primary font-bold mt-1">
                    CEO BimSpeed Solution · Chuyên gia OpenClaw AI Agent
                  </p>
                </div>

                <p className="text-sm sm:text-base text-on-surface-variant leading-relaxed">
                  Tony Hoang là người trực tiếp xây dựng và vận hành các hệ thống
                  OpenClaw cho marketing, xuất bản và e-commerce. Anh đã train
                  hàng nghìn học viên biến OpenClaw thành &quot;đội ngũ nhân viên số&quot; 24/7 —
                  từ Research, Ideation, Content, viết sách đến Website — chạy ngay trên máy của học viên.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-3">
                  {[
                    ...
                    { icon: "smart_toy", value: "18+", label: "Agents đã build" },
                  ].map((stat) => (
                    <div
                      key={stat.label}
                ...
                <div className="pt-2 space-y-2">
                  {[
                    ...
                    "Review identity files, security & capstone build của từng học viên",
                    "Hỗ trợ debug OpenClaw, Discord channels, MCP, sub-agents trong suốt quá trình build",
                  ].map((item) => (
                    <div
                      key={item}
