...
const before = [
  ...
  "Thuê writer ngoài: đắt & không hiểu thương hiệu",
  "Landing page phải đợi dev 2 tuần",
  "Ebook 50 trang — nghĩ 6 tháng chưa xong",
  "Email inbox 200+ chưa trả lời",
];

const after = [
  "10 bài content/ngày, đúng tone thương hiệu",
  "Research tự động: đối thủ, xu hướng, từ khoá — chạy khi bạn đang ngủ",
  "CLAUDE.md = nhân viên hiểu brand 24/7, không bao giờ nghỉ",
  "Landing page production-ready trong 30 phút",
  "Ebook 50 trang — outline + draft trong 1 buổi",
  "AI tự classify email, reply, tag — bạn chỉ review",
];

export default function TransformationMastery() {
  return (
