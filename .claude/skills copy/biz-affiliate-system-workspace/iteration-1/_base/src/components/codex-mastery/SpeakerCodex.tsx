...
export default function SpeakerCodex() {
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-6 bg-surface-container-lowest" id="speakers">
            ...
            <div className="flex flex-col md:flex-row gap-6 sm:gap-10 items-center md:items-start">
              <div className="shrink-0 w-52 h-64 sm:w-72 sm:h-88 rounded-2xl sm:rounded-3xl overflow-hidden border-2 border-primary shadow-xl relative">
                ...
                <div className="absolute top-3 right-3 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-black/60 backdrop-blur">
                  ...
                  <span className="text-[10px] text-white font-bold uppercase">Live Mentor</span>
                </div>
              </div>
              ...
              <div className="space-y-4 sm:space-y-5 text-center md:text-left flex-1">
                <div>
                  ...
                  <p className="text-sm sm:text-base text-primary font-bold mt-1">
                    CEO BimSpeed Solution · Chuyên gia ChatGPT Codex & AI Productivity
                  </p>
                </div>
                ...
                <p className="text-sm sm:text-base text-on-surface-variant leading-relaxed">
                  ...
                  hàng nghìn học viên biến ChatGPT Codex thành &quot;hệ automation marketing&quot; 24/7 —
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-3">
                  {[
                    ...
                    >
                      ...
                      <div className="text-primary font-black text-lg sm:text-xl">{stat.value}</div>
                ...
                <div className="pt-2 space-y-2">
                  {[
                    ...
                    "Review pipeline và capstone project của từng học viên",
                    "Hỗ trợ debug automation, tích hợp tool trong quá trình build",
                  ].map((item) => (
                    <div key={item} className="flex gap-2 text-xs sm:text-sm text-on-surface-variant text-left">
